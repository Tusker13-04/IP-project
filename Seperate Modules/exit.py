...
def ext():
    if data.get() == '0' or str(num_var.get()) == '0':
        ...
        messagebox.showinfo(title="Success", message="Successfully entered")
        window.destroy()
        import page1
...
# Creating widgets
exit_label = tkinter.Label(text="exit Register page", bg='#333333', fg="#FF3399", font=("Arial", 20))
...
exit_button = tkinter.Button(text="Submit", bg="#FF3399", fg="#FFFFFF", font=("Arial", 16), command=ext)
num_exit = tkinter.Entry(textvariable=num_var, font=('Arial', 10))
